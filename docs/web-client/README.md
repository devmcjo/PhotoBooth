...
| 작성일 | 2026-07-30 |
| 상태 | **구현 진행 중 — WBS Step 0~8 + 서버 선행작업(B1·B2·B4) + 사용자 액션 A1~A5 완료**(2026-07-31, 브랜치 `feature/web-client-foundation`, 웹 492 / 서버 316 / Windows 937 테스트 통과). 재개는 [15 · 구현 관례와 재개 가이드](./15-implementation-conventions.md), 사람이 할 일은 [14 · 인수인계와 사용자 액션](./14-handoff-and-user-actions.md) |
